...
var host = process.env.POSTGRES_SERVER || "postgres"; // "192.168.1.57"; // "postgres"; // "127.0.0.1"; // "AuggieTheDoggie"; // 
var port = process.env.POSTGRES_PORT || 5432;
